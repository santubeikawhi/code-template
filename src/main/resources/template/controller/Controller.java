...
public class ${Table}Controller {
  ...
  public RestVo<Page<${Table}Vo>> noAuthPage(${Table}PageReq req){
      return RestVo.SUCCESS(${table}Service.page(req));
  }
  ...
  public RestVo<Page<${Table}Vo>> page(${Table}PageReq req){
      return RestVo.SUCCESS(${table}Service.page(req));
  }
  ...
  public RestVo<List<${Table}Vo>> noAuthList(${Table}PageReq req){
      return RestVo.SUCCESS(${table}Service.list(req));
  }
  ...
  public RestVo<List<${Table}Vo>> list(${Table}PageReq req){
      return RestVo.SUCCESS(${table}Service.list(req));
  }
